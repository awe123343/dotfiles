...
alias mosh='TERM=${TERM/xterm-ghostty/xterm-256color} mosh'
alias w1='watch -n 1 '
alias aria2='aria2c --conf-path=$HOME/.aria2/aria2.conf -D'
alias dl='aria2c --conf-path=$HOME/.aria2/aria2.conf --enable-rpc=false --input-file="" --save-session=""'
alias dlg='gopeed -C 64 -D $HOME/Downloads'
