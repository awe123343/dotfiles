# Generated by Powerlevel10k configuration wizard on 2023-08-29 at 17:04 PDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    local      stash=' ' # black foreground
    # local   modified='%0F' # black foreground
    local   modified='' # black foreground
    local   unstaged=' ' # black foreground
    ...
    [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="  ${clean}${VCS_STATUS_COMMIT[1,8]}"
